...
class _EditPatientInfoPageState extends State<EditPatientInfoPage> {
  ...
  initState() {
    ...
    if (reasonForTestChoices.contains(widget.patient.reasonForTest)) {
      ...
      // reasonForTest = 'Other';
      if (widget.patient.reasonForTest != null && widget.patient.reasonForTest!.contains('after')) {
        reasonForTest = 'At X months after treatment';
        xMonthsAfterController.text = widget.patient.reasonForTest ?? '';
      } else if (widget.patient.reasonForTest != null && widget.patient.reasonForTest!.contains('during')) {
          ...
          child: BlocConsumer<OrderBloc, OrderState>(
              ...
              listener: (ctx, state) async {
                if (state is EditedPatientState) {
                  ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Edited Patient Data!')));
                  await Future.delayed(Duration(seconds: 1));
                  Navigator.pushReplacementNamed(context, OrderDetailPage.orderDetailPageRouteName, arguments: widget.orderId);
                } else if (state is ErrorState) {
                  ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Errro Adding Patient!')));
                }
              },
                        ...
                        child: Column(
                          children: [
                            ...
                            Container(
                              ...
                              child: Text(
                                widget.patient.resultAvaiable || !widget.canEdit ? 'Patient Info' : 'Edit Patient Info',
                            ...
                            !widget.patient.resultAvaiable && widget.canEdit && siteOfTB == 'Other'
                                ? TextField(
                            ...
                            !widget.patient.resultAvaiable && widget.canEdit && registrationGroup == 'Other'
                                ? TextField(
                            ...
                            !widget.patient.resultAvaiable && widget.canEdit && reasonForTest == 'At X months during treatment'
                                ? TextField(
                            ...
                            !widget.patient.resultAvaiable && widget.canEdit && reasonForTest == 'At X months after treatment'
                                ? TextField(
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        !e.rejected ? Text('Accepted : ${e.assessed}') : Container(),
                        ...
                        (state is LoadedSingleOrder && state.order.status == 'Received') && (!e.rejected) && (e.testResult != null)
                            ? Align(
                                alignment: AlignmentDirectional.centerEnd,
                                child: IconButton(
                                  color: Colors.green,
                        ...
                        widget.canAddResult && (state is LoadedSingleOrder && state.order.status == 'Received') && (e.testResult == null)
                            ? Align(
                                alignment: AlignmentDirectional.centerEnd,
                                child: IconButton(
                                  color: Colors.green,
                                  onPressed: () async {
                                    ...
                                    if (create == true && e.type == 'Sputum') {
                                      ...
                                      e.reason = 'Stool Specimen is in $stoolCondition type. Not in Formed State!';
                                    ...
                                    } else if (create == true && e.type == 'Urine') {
                                      e.assessed = true;
